...
export default function ChatsScreen() {
  ...
  return <Screen scroll={false} style={styles.screen}>
    <TopBar title="Chats" subtitle="Bridging Abilities Staff" onProfile={() => router.push('/profile')} right={<PressableScale accessibilityLabel="New conversation" onPress={() => router.push('/new-chat')}><Ionicons name="create-outline" size={24} color={colors.foreground} /></PressableScale>} />
